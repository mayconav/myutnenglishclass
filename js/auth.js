(function () {
  ...
  function startStudentSession(uid, data) {
    ...
    if (typeof window.__UTN_BINGO_SET_STUDENT__ === "function") window.__UTN_BINGO_SET_STUDENT__(uid, data);
  ...
  function resetToGuestUI() {
    ...
    show($("app-header"));
    show($("main"));
    if (typeof window.__UTN_BINGO_SET_STUDENT__ === "function") window.__UTN_BINGO_SET_STUDENT__(null, null);
  }
  ...
  auth.onAuthStateChanged(function (user) {
    ...
    if (normalizeEmail(user.email) === normalizeEmail(ADMIN_EMAIL)) {
      ...
      initAdminPanel();
      if (typeof window.__UTN_BINGO_HOST_INIT__ === "function") window.__UTN_BINGO_HOST_INIT__();
      return;
    }
