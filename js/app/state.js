    ...
    try {
      ...
      if (raw) {
        ...
        return {
          ...
          bingoStats: parsed.bingoStats && typeof parsed.bingoStats === "object" ? {
            wins: typeof parsed.bingoStats.wins === "number" ? parsed.bingoStats.wins : 0,
            played: typeof parsed.bingoStats.played === "number" ? parsed.bingoStats.played : 0
          } : base.bingoStats
        };
      }
